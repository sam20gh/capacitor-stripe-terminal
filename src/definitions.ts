...
export interface StripeTerminalConfig {
  ...
  onReportReaderSoftwareUpdateProgress: () => Promise<{progress:ReaderSoftwareUpdate | null}>
  onFinishInstallingUpdate: () => Promise<{update:ReaderSoftwareUpdate | null}>
  onReportAvailableUpdate: () => Promise<{update:ReaderSoftwareUpdate | null}>
  onStartInstallingUpdate: () => Promise<{update:ReaderSoftwareUpdate | null}>
}
