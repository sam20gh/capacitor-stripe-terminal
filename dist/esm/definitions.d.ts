 ...
 * @category Reader
 */
export interface HandoffConnectionConfiguration extends ConnectionConfiguration {
}
/**
 * @category Reader
 */
export interface LocalMobileConnectionConfiguration extends ConnectionConfiguration {
    /**
...
export interface StripeTerminalInterface {
    ...
    addListener(eventName: 'requestConnectionToken', listenerFunc: () => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'didReportUnexpectedReaderDisconnect', listenerFunc: () => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'readersDiscovered', listenerFunc: (event: {
        readers?: Reader[];
    }) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'didChangeConnectionStatus', listenerFunc: (status: any) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'didReportReaderSoftwareUpdateProgress', listenerFunc: (data: any) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'didRequestReaderDisplayMessage' | 'didRequestReaderInput', listenerFunc: (data: any) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'didReportAvailableUpdate' | 'didStartInstallingUpdate', listenerFunc: (data: any) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'didFinishInstallingUpdate', listenerFunc: (data: {
        update?: ReaderSoftwareUpdate;
        error?: string;
    }) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
    addListener(eventName: 'didStartReaderReconnect' | 'didSucceedReaderReconnect' | 'didFailReaderReconnect', listenerFunc: (data: null) => void): Promise<PluginListenerHandle> & PluginListenerHandle;
